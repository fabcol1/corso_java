	...
	<div class="container">
		...
		<div class="row" style="margin-top: 40px">
			<div class="col-md-6 col-md-offset-3">
				<form action="/UserManagementWeb/PasswordRecovery" method="POST">
		...
		<div class="row" style="margin-top: 40px">
			<div class="col-md-6 col-md-offset-3">
				<p style="color:green; background-color: font-size: 16px; font-weight: bold;">Ti è stato inviato per email il link per generare la nuova password.</p>
			</div>
		</div>
	</div>
</body>
