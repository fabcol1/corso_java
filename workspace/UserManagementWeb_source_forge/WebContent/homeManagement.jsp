            ...
            <div class="col-lg-12">
               <div class="main-box no-header clearfix">
                    <div class="main-box-body clearfix">
                        ...
                        document.write ("<div class='dropdown'><button type='button' class = 'icon-button' id = 'minidrop' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'><span class='glyphicon glyphicon-chevron-down'></span></button>")
                        document.write ("<div class='dropdown-menu'><a class='dropdown-item' href='#'>Action</a><a class='dropdown-item' href='#'>Another action</a></div></div>")
