            ...
            <nav class="navbar navbar-inverse navbar-fixed-top">
              <div class="container-fluid">
                ...
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="#"><img src="images/logo_proxima.png"></a>
                </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group row">
                                 <div class="col-sm-10"> 
                                		...
                                		<a href="<%=liConnection.getLIAuthUrl()%>"><img border="0" src="images/Logo-linkedin.png" alt="logolinkdin" height="47px" width="40px"></a>
                              </div>
                              <script>
