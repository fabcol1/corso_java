...
//		$scope.colors = ['rgb(65, 65, 65)', 'rgb(150, 65, 65)', 'rgb(65, 150, 65)', 'rgb(65, 65, 150)', 'rgb(65, 150, 150)'];
		...
		chartGenerator($http, $scope, $q, '/api/ethereum/lastDay/', 'ETH/USD ( Ethereum )', 'minute', 'daily');
		chartGenerator($http, $scope, $q, '/api/ethereum/lastWeek/',  'ETH/USD ( Ethereum )', 'day', 'weekly');
		chartGenerator($http, $scope, $q, '/api/ethereum/lastMonth/', 'ETH/USD ( Ethereum )', 'day', 'monthly');
		chartGenerator($http, $scope, $q, '/api/ethereum/lastYear/',  'ETH/USD ( Ethereum )', 'month', 'yearly');
	});
});
