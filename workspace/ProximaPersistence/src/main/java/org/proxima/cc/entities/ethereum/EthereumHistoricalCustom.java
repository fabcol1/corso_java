...
/**
 * The persistent class for the ethereumHistoricalCustom database table.
 * 
 */
public class EthereumHistoricalCustom implements Serializable {
	...
	public EthereumHistoricalCustom() {
	}

	public EthereumHistoricalCustom(Long id, Long cryptoexchangevaluesproviderid, Long currencyregistryid,
			LocalDateTime exchangetime, BigDecimal exchangevalue, String providerIconImgpath, String providerLabel,
			String providerSite, String currencyLabel, String currencySymbol) {
		this.id = id;
	...
	public EthereumHistoricalCustom(Long id, Long cryptoexchangevaluesproviderid, Long currencyregistryid,
			LocalDateTime exchangetime, BigDecimal exchangevalue) {
		this.id = id;
		this.cryptoexchangevaluesproviderid = cryptoexchangevaluesproviderid;
		this.currencyregistryid = currencyregistryid;
		this.exchangetime = exchangetime;
	...
	/**
	 * @param providerIconImgpath
	 *            the providerIconImgpath to set
	 */
