...
//		$scope.colors = ['rgb(65, 65, 65)', 'rgb(150, 65, 65)', 'rgb(65, 150, 65)', 'rgb(65, 65, 150)', 'rgb(65, 150, 150)'];
		...
		chartGenerator($http, $scope, $q, '/api/litecoin/lastDay/', 'LTC/USD ( Litecoin )', 'minute', 'daily');
		chartGenerator($http, $scope, $q, '/api/litecoin/lastWeek/',  'LTC/USD ( Litecoin )', 'day', 'weekly');
		chartGenerator($http, $scope, $q, '/api/litecoin/lastMonth/', 'LTC/USD ( Litecoin )', 'day', 'monthly');
		chartGenerator($http, $scope, $q, '/api/litecoin/lastYear/',  'LTC/USD ( Litecoin )', 'month', 'yearly');
	});
});
