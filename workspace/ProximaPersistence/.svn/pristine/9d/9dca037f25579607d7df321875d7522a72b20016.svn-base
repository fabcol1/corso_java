...
public class QuestionCategoryManageRestController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<QuestionCategory> getQuestionyCategoryById(@PathVariable("id") final Long id) {
		logger.debug("QuestionManageRestController.getQuestionyCategoryById - START");
