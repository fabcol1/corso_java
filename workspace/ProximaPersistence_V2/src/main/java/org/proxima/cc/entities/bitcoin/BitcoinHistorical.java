...
public class BitcoinHistorical implements Serializable {
	...
	public String toString() {
		return "BitcoinHistorical [id=" + id + ", cryptoexchangevaluesproviderid=" + cryptoexchangevaluesproviderid
				+ ", currencyregistryid=" + currencyregistryid + ", exchangetime=" + exchangetime + ", exchangevalue="
				+ exchangevalue + "]";
	}
