...
//	    CriteriaBuilder criteriaBuilder = session.getCriteriaBuilder();
//	    CriteriaQuery<org.entities.User> criteriaQuery = criteriaBuilder.createQuery(org.entities.User.class);
//	    Root<org.entities.User> root = criteriaQuery.from(org.entities.User.class);
//	    criteriaQuery.select(root);
//	    Query<org.entities.User> query = session.createQuery(criteriaQuery);
//	    List<org.entities.User> weatherModelList = query.getResultList();
//	    logger.info(weatherModelList.size());
//	}
