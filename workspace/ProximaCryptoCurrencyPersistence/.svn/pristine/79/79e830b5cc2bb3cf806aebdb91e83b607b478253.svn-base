...
public class RestValidationHandler {
	...
	public ResponseEntity<FieldValidationErrorDetails> handleNotReadableError(
			HttpMessageNotReadableException mNotReadableException, HttpServletRequest request) {
		FieldValidationErrorDetails fErrorDetails = new FieldValidationErrorDetails();
		fErrorDetails.setError_timeStamp(new Date().getTime());
		fErrorDetails.setError_status(HttpStatus.BAD_REQUEST.value());
		fErrorDetails.setError_title("Not Readable Error");
		fErrorDetails.setError_detail(mNotReadableException.getMessage());
		fErrorDetails.setError_developer_Message(mNotReadableException.getClass().getName());
		fErrorDetails.setError_path(request.getRequestURI());
		return new ResponseEntity<FieldValidationErrorDetails>(fErrorDetails, HttpStatus.BAD_REQUEST);
	}
